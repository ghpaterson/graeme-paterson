...
export default function Hero() {
  return (
    <section
      id="header"
      className="grid h-screen md:h-[90vh] grid-cols-1 md:grid-cols-12 gap-4"
    >
      <div className=" md:col-span-4 rounded-lg bg-slate-300 px-6 py-6 flex flex-col gap-4">
        <div>
          <h1 className="text-xl md:text-3xl">Graeme Paterson</h1>
      ...
      <div className="md:col-span-8 grid grid-rows-2 gap-4">
        <div className="row-span-1 rounded-lg bg-bone"></div>
        <div className="row-span-1 rounded-lg bg-moss/50 hover:bg-moss px-4 py-4">
